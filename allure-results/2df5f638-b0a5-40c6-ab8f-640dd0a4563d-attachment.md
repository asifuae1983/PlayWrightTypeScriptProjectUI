...
```
Error: locator.click: Error: strict mode violation: locator('a[href="/test_cases"]') resolved to 4 elements:
...
Call log:
  - waiting for locator('a[href="/test_cases"]')

    at HomePage.clickTestCasesLink (/app/pages/HomePage.js:37:53)
    at /app/tests/verifyTestCasesPage.spec.js:24:24
```
...
```ts
   ...
   8 |         this.cartLink = '.shop-menu a[href="/view_cart"]';
  ...
  14 |         this.subscriptionText = 'h2:has-text("Subscription")';
  15 |         this.subscriptionEmailInput = '#subscribe_email';
  16 |         this.subscriptionButton = '#subscribe';
  17 |         this.successAlert = '#success-subscribe'; // Assuming an ID for the success alert
  18 |     }
  19 |
  20 |     async goto() {
