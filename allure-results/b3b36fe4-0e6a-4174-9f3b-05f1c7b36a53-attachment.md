...
Call log:
  - waiting for locator('//div[@class=\'productinfo\' and ./p[text()=\'Blue Top\']]').first()
...
```ts
   ...
   28 |         this.productItemByName = (name) => `//div[@class='productinfo' and ./p[text()='${name}']]`; // XPath to find product container by name precisely matching product name in <p>
