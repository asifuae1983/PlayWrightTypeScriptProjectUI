...
```
Error: locator.click: Error: strict mode violation: locator('a.test_cases_list[href="/test_cases"]') resolved to 3 elements:
    1) <a href="/test_cases" class="test_cases_list">…</a> aka getByRole('link', { name: 'Test Cases', exact: true })
    2) <a href="/test_cases" class="test_cases_list">…</a> aka locator('a').filter({ hasText: 'Test Cases' }).nth(2)
    3) <a href="/test_cases" class="test_cases_list">…</a> aka locator('a').filter({ hasText: 'Test Cases' }).nth(3)

Call log:
  - waiting for locator('a.test_cases_list[href="/test_cases"]')
...
```ts
  ...
  10 |         this.testCasesLink = 'a.test_cases_list[href="/test_cases"]';
